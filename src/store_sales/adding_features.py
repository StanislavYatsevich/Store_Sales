...
@click.command()
@click.option('--input_data_folder_path', default=INPUT_DATA_FOLDER_PATH, type=click.Path(exists=True), help='Path to the folder with input data files')
@click.option('--processed_data_folder_path', default=PROCESSED_DATA_FOLDER_PATH, type=click.Path(), help='Path to the folder where processed files are saved to')
